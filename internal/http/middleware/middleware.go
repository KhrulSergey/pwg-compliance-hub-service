...
func AuthMiddleware(h fasthttp.RequestHandler, key string) fasthttp.RequestHandler {
...
func AuthMiddlewareSetupResponse(h fasthttp.RequestHandler) fasthttp.RequestHandler {
	return func(ctx *fasthttp.RequestCtx) {
